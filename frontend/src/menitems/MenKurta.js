...
import { kurta, menkurta } from '../Men/kurta'
...
<Link to={`/Menkurta/${x._id}`}><img src={x.image} style={{height:"13rem"}} className="card-img-top rounded" alt="..." /></Link>
<div className="card-body">
<p className=''>{x.description.slice(0,10)}....</p>
