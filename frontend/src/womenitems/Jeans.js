...
<div className="card rounded" style={{width: '15rem'}}>
 <Link to={`/jeans/${x._id}`}><img src={x.imageUrl} style={{height:"13rem"}} className="card-img-top rounded" alt="..." /></Link>
<div className="card-body">
<p className=''>{x.name.slice(0,15)}....</p>
