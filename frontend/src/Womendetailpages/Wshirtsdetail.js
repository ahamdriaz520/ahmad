...
const Wshirtsdetail = () => {
  const {_id} = useParams()
  const data = womenshirts.find((x)=>x._id == _id)
...
return (
<Layout title={'Women-Shirt detail'}>
    ...
    <div className="wrapper row">
      <div className="preview col-md-6">
        <div className="preview-pic tab-content">
          <div className="tab-pane active" id={data.imageUrl}><img style={{height:'25rem'}}  src={data.imageUrl}  style={{height:"30rem"}} /></div>
